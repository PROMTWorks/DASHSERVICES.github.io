/* DASH MOBILE SERVICES role guard for the live admin-shell iframe. */
(function(){
  ...
  function apply(doc){
    ...
    if(typeof doc.defaultView.show==='function'&&!doc.defaultView.__dashRoleWrapped){const original=doc.defaultView.show;doc.defaultView.show=function(section,button){const needed=sections[section];if(!superAdmin&&needed&&!access.permissions.has(needed)){alert('Your DASH MOBILE SERVICES role does not have permission to access this area.');return}return original.apply(this,arguments)};doc.defaultView.__dashRoleWrapped=true;}
