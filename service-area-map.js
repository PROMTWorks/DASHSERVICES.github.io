(function(){
  ...
  function initMap(){
    ...
    // Star marker identifies Myrtle Beach as DASH Services' base.
    ...
    var section=host.closest('section')||host.parentElement;var old=section.querySelector('.service-area-travel-note');if(old)old.remove();
